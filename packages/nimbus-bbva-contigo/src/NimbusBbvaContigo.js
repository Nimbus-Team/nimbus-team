          ...
          <section class="container" id="gridContainer">
              <div class="prioridadesContainer">
                    <div class="card blueBox">
                      <div class="cardHeader"><p class="title">Mejorar la salud finnciera de los clientes</p></div>
                      <div class="cardBody">
                          <div class="dataContainer">
                            <div class="tweetsContainer"><p class="totalTweets">50</p><span>Tweets analizados</span></div>
                            <div class="badWord"><p>No</p></div>
                            <div class="goodWord"><p>Verde</p></div>
                          </div>
                          <div class="actionContainer">
                            <p>Congelar interéses durante 3 meses</p>
                          </div>
                      </div>
                      <div class="cardFooter">
                        <div class="userContainer" title="Banda personal">
                          <div class="active">
                    ...
                    <div class="card blueBox">
                      <div class="cardHeader"><p class="title">Ayudar a los clientes en la transición facia el futuro sotenible</p></div>
                      <div class="cardBody">
                        <div class="dataContainer">
                          <div class="tweetsContainer"><p class="totalTweets">50</p><span>Tweets analizados</span></div>
                          <div class="badWord"><p>No</p></div>
                    ...
                    <div class="card blueBox">
                      <div class="cardHeader"><p class="title">Crecer en clientes</p></div>
                      <div class="cardBody">
                        <div class="dataContainer">
                          <div class="tweetsContainer"><p class="totalTweets">50</p><span>Tweets analizados</span></div>
                          <div class="badWord"><p>No</p></div>
                    ...
                    <div class="card blueBox loading">
                      <div class="cardHeader"><p class="title">Buscar la excelencia operativa</p></div>
                      <div class="cardBody">
                        <div class="dataContainer">
                          <div class="tweetsContainer"><p class="totalTweets">50</p><span>Tweets analizados</span></div>
                          <div class="badWord"><p>No</p></div>
